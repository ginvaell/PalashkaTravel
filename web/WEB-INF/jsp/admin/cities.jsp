            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <fmt:message key='cities'/>/<a href="/admin/add_city"><fmt:message key='addNew'/></a>
                    </div>
                    <!-- /.panel-heading -->
                                            ...
                                            <c:forEach items="${cities}" var="city">
                                                <tr class="gradeA odd" role="row">
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-default " href="/admin/edit_city?id=${city.id}"><span class="glyphicon glyphicon-edit"></span></a>
                                                        <a class="btn btn-primary " href="/admin/delete_city?id=${city.id}"><span class="glyphicon glyphicon-remove"></span></a>
                                                    </td>
                                                </tr>
                                            </c:forEach>
